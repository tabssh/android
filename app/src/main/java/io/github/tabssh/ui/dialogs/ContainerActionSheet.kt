...
object ContainerActionSheet {
    ...
    fun show(
        ...
        val root = LayoutInflater.from(context)
            .inflate(R.layout.sheet_container_actions, null, false)
        ...
        root.findViewById<TextView>(R.id.text_sheet_title).text =
            ContainerText.display(title.toString())
        val subtitleView = root.findViewById<TextView>(R.id.text_sheet_subtitle)
        if (subtitle.isNullOrBlank()) {
            subtitleView.visibility = android.view.View.GONE
        } else {
            subtitleView.visibility = android.view.View.VISIBLE
            subtitleView.text = ContainerText.display(subtitle.toString())
        }
