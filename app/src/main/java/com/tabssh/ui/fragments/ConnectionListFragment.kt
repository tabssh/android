package com.tabssh.ui.fragments
...
class ConnectionListViewModel(application: android.app.Application) : androidx.lifecycle.AndroidViewModel(application) {
    ...
    private val database = com.tabssh.storage.database.TabSSHDatabase.getDatabase(application)
    ...
    private fun loadConnections() {
        ...
        viewModelScope.launch {
            try {
                ...
                com.tabssh.utils.logging.Logger.e("ConnectionListViewModel", "Failed to load connections", e)
    ...
    fun deleteConnection(connection: ConnectionProfile) {
        viewModelScope.launch {
            try {
                ...
                com.tabssh.utils.logging.Logger.i("ConnectionListViewModel", "Deleted connection: ${connection.name}")
            } catch (e: Exception) {
                com.tabssh.utils.logging.Logger.e("ConnectionListViewModel", "Failed to delete connection", e)
            }
        }
    }
}