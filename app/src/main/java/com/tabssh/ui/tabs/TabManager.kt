...
class TabManager(private val maxTabs: Int = 10) {
    ...
    private fun notifyTabConnectionStateChanged(tab: SSHTab, state: com.tabssh.ssh.connection.ConnectionState) {
    ...
    fun saveTabState() {
        ...
        tabs.forEachIndexed { index, tab ->
            ...
            val tabSession = com.tabssh.storage.database.entities.TabSession(
